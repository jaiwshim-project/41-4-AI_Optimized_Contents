  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-700">AIO/GEO Optimizer 사용 가이드</p>
              </div>
            </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5">
        {/* 소개 */}
        <section className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl shadow-sm border-2 border-indigo-200 p-6">
          <h2 className="text-sm font-bold bg-gradient-to-r from-indigo-700 to-purple-700 bg-clip-text text-transparent mb-3">AIO/GEO Optimizer란?</h2>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-amber-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">콘텐츠 분석/생성 및 이미지 생성을 위해 API 키를 입력해야 합니다. 상단 네비게이션의 &quot;API Key&quot; 버튼을 클릭하면 입력 패널이 열립니다.</p>
          <div className="space-y-3">
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
              <h3 className="text-[12pt] font-semibold text-amber-800 mb-2 flex items-center gap-2">
                Gemini API Key
                <span className="px-2 py-0.5 bg-amber-200 text-amber-700 text-[10px] font-bold rounded-full">필수</span>
              </h3>
              <p className="text-[10px] text-gray-800 mb-2">콘텐츠 분석, 생성, AI 이미지 생성에 사용됩니다.</p>
              <div className="bg-white rounded-lg p-3 border border-amber-200">
                <p className="text-[10px] font-medium text-amber-700 mb-1">발급 방법</p>
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
              ...
              <p className="text-[10px] text-gray-800">입력한 API 키는 브라우저 로컬 스토리지에 안전하게 저장되며, 서버로 전송되지 않습니다. 브라우저를 닫아도 키가 유지되므로 매번 다시 입력할 필요가 없습니다.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-blue-200 p-6">
          ...
          <div className="space-y-3 text-gray-800">
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
              ...
              <p className="text-[10px]">분석하고 싶은 콘텐츠(블로그 글, 기사, 웹페이지 텍스트 등)를 텍스트 입력 영역에 붙여넣기 합니다.</p>
            </div>
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
              <h3 className="text-[12pt] font-semibold text-blue-800 mb-2">타겟 키워드 (선택)</h3>
              <p className="text-[10px]">최적화하려는 주요 검색 키워드를 입력합니다. 입력하면 해당 키워드에 대한 맞춤 분석을 제공합니다.</p>
            </div>
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
              <h3 className="text-[12pt] font-semibold text-blue-800 mb-2">URL (선택)</h3>
              <p className="text-[10px]">콘텐츠가 게시된 URL을 입력하면 추가적인 컨텍스트를 바탕으로 분석합니다.</p>
            </div>
          </div>
        </section>

        {/* 콘텐츠 생성 */}
        <section className="bg-white rounded-xl shadow-sm border-2 border-emerald-200 p-6">
          <h2 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
          ...
          <p className="text-[10px] text-gray-800 mb-3">AI가 AIO/GEO에 최적화된 콘텐츠를 자동으로 생성합니다. 주제, 카테고리, 톤을 설정하면 맞춤형 콘텐츠가 만들어집니다.</p>
          <div className="space-y-3">
            <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-100">
              <h3 className="text-[12pt] font-semibold text-emerald-800 mb-2">기본 설정</h3>
              <ul className="space-y-2 text-[10px] text-gray-800">
            ...
            <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-100">
              <h3 className="text-[12pt] font-semibold text-emerald-800 mb-2 flex items-center gap-2">
                참조 자료 활용 (RAG 방식)
                <span className="px-2 py-0.5 bg-emerald-200 text-emerald-700 text-[10px] font-bold rounded-full">NEW</span>
              </h3>
              <p className="text-[10px] text-gray-800 mb-3">추가 요구사항 입력란에 참조 자료를 입력하거나, 파일을 업로드하면 해당 정보를 기반으로 더 정확하고 구체적인 콘텐츠를 생성합니다.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-white rounded-lg p-3 border border-emerald-200">
                  <p className="text-[10px] font-medium text-emerald-700 mb-1">텍스트 입력</p>
                  <p className="text-[10px] text-gray-700">추가 요구사항 입력란에 통계, 사실관계, 연구 결과 등 참조할 정보를 직접 입력합니다.</p>
                </div>
                <div className="bg-white rounded-lg p-3 border border-emerald-200">
                  <p className="text-[10px] font-medium text-emerald-700 mb-1">파일 업로드</p>
                  <p className="text-[10px] text-gray-700">TXT, MD, CSV, JSON, HTML 형식의 참조 파일을 업로드하면 파일 내용이 자동으로 반영됩니다.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* 분석 결과 탭 */}
        <section className="bg-white rounded-xl shadow-sm border-2 border-sky-200 p-6">
          <h2 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
          ...
          <div className="space-y-3">
            <div className="bg-sky-50 rounded-xl p-4 border border-sky-100">
              ...
              <p className="text-[10px] text-gray-800">전체 AIO/GEO 점수와 주요 지표를 한눈에 확인할 수 있는 대시보드입니다. 콘텐츠의 전반적인 AI 최적화 수준을 빠르게 파악할 수 있습니다.</p>
            </div>
            <div className="bg-sky-50 rounded-xl p-4 border border-sky-100">
              <h3 className="text-[12pt] font-semibold text-sky-800 mb-2">AIO 분석 (AI Overview)</h3>
              <p className="text-[10px] text-gray-800">Google AI Overview에 콘텐츠가 인용될 가능성을 분석합니다. 구조화된 답변 형식, 신뢰성, 간결성 등 AIO 노출에 영향을 미치는 요소를 평가합니다.</p>
            </div>
            <div className="bg-sky-50 rounded-xl p-4 border border-sky-100">
              <h3 className="text-[12pt] font-semibold text-sky-800 mb-2">GEO 분석 (Generative Engine Optimization)</h3>
              <p className="text-[10px] text-gray-800">생성형 AI 엔진이 콘텐츠를 이해하고 활용하기 쉬운 정도를 분석합니다. 의미적 명확성, 전문성, 컨텍스트 완성도 등을 평가합니다.</p>
            </div>
            <div className="bg-sky-50 rounded-xl p-4 border border-sky-100">
              <h3 className="text-[12pt] font-semibold text-sky-800 mb-2">키워드 분석</h3>
              <p className="text-[10px] text-gray-800">콘텐츠 내 주요 키워드의 분포, 밀도, 관련성을 분석합니다. 타겟 키워드가 입력된 경우 해당 키워드의 최적화 상태를 집중적으로 확인합니다.</p>
            </div>
            <div className="bg-sky-50 rounded-xl p-4 border border-sky-100">
              <h3 className="text-[12pt] font-semibold text-sky-800 mb-2">개선 제안</h3>
              <p className="text-[10px] text-gray-800">분석 결과를 바탕으로 콘텐츠 개선을 위한 구체적이고 실행 가능한 제안을 제공합니다. 우선순위별로 정리되어 효율적인 최적화 작업이 가능합니다.</p>
            </div>
          </div>
        </section>

        {/* 대시보드 */}
        <section className="bg-white rounded-xl shadow-sm border-2 border-violet-200 p-6">
          <h2 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
          ...
          <p className="text-[10px] text-gray-800 mb-3">대시보드에서는 분석 및 생성한 모든 콘텐츠의 이력을 관리하고, 다양한 방식으로 콘텐츠를 활용할 수 있습니다.</p>

          <div className="space-y-3">
            <div className="bg-violet-50 rounded-xl p-4 border border-violet-100">
              <h3 className="text-[12pt] font-semibold text-violet-800 mb-3">이력 목록</h3>
              <p className="text-[10px] text-gray-800 mb-2">생성하거나 분석한 모든 콘텐츠가 날짜순으로 정리됩니다. 각 항목에는 제목, 날짜, 카테고리가 표시되며, &quot;보기&quot; 버튼을 클릭하면 상세 페이지로 이동합니다.</p>
              <p className="text-[10px] text-gray-700">수정/재생성한 콘텐츠는 원본 아래에 수정본으로 표시됩니다.</p>
            </div>

            <div className="bg-violet-50 rounded-xl p-4 border border-violet-100">
              <h3 className="text-[12pt] font-semibold text-violet-800 mb-3">상세 페이지 기능</h3>
              <p className="text-[10px] text-gray-800 mb-3">각 콘텐츠의 상세 페이지(<code className="bg-violet-100 px-1.5 py-0.5 rounded text-violet-700 text-[10px]">/dashboard/[id]</code>)에서는 고유한 URL로 언제든 다시 접근할 수 있습니다.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-white rounded-lg p-3 border border-violet-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[10px] font-medium text-indigo-700">블로그 붙여넣기용 복사</p>
                  </div>
                  <p className="text-[10px] text-gray-600">화면에 보이는 서식 그대로 복사됩니다. 블로그 에디터에 붙여넣기 하면 제목, 표, 리스트 등이 유지됩니다.</p>
                </div>
                <div className="bg-white rounded-lg p-3 border border-violet-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[10px] font-medium text-amber-700">제목 복사</p>
                  </div>
                  <p className="text-[10px] text-gray-600">콘텐츠 제목만 클립보드에 복사합니다.</p>
                </div>
                <div className="bg-white rounded-lg p-3 border border-violet-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[10px] font-medium text-sky-700">본문 복사</p>
                  </div>
                  <p className="text-[10px] text-gray-600">본문 내용을 HTML 서식과 함께 복사합니다. 표 등 서식이 유지됩니다.</p>
                </div>
                <div className="bg-white rounded-lg p-3 border border-violet-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[10px] font-medium text-emerald-700">이미지로 복사</p>
                  </div>
                  <p className="text-[10px] text-gray-600">콘텐츠를 PNG 이미지로 캡처하여 클립보드에 복사합니다. 편집 불가한 이미지 형태로 붙여넣기 가능합니다.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-violet-50 rounded-xl p-4 border border-violet-100">
              <h3 className="text-[12pt] font-semibold text-violet-800 mb-3 flex items-center gap-2">
                본문 수정 기능
                <span className="px-2 py-0.5 bg-violet-200 text-violet-700 text-[10px] font-bold rounded-full">NEW</span>
              </h3>
              <p className="text-[10px] text-gray-800 mb-3">&quot;본문 수정&quot; 버튼을 클릭하면 마크다운 편집 모드로 전환됩니다. 상단에 편집 도구 바가 고정되어 스크롤해도 항상 접근할 수 있습니다.</p>
              <div className="bg-white rounded-lg p-4 border border-violet-200">
                <p className="text-[10px] font-medium text-violet-700 mb-2">편집 도구 바 기능</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={tool.label} className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 rounded text-[10px] text-gray-700">
                      <span className="font-bold">{tool.label}</span>
                      <span className="text-gray-400">{tool.desc}</span>
                    </span>
                  ))}
                </div>
                <p className="text-[10px] text-gray-500 mt-2">수정 후 &quot;저장하기&quot; 버튼을 클릭하면 변경 내용이 저장됩니다.</p>
                <div className="mt-3 pt-3 border-t border-violet-100">
                  <p className="text-[10px] font-medium text-violet-700 mb-1">찾기/바꾸기 기능</p>
                  <p className="text-[10px] text-gray-600">편집 도구 바의 &quot;찾기/바꾸기&quot; 버튼을 클릭하면 텍스트 검색 및 일괄 바꾸기 패널이 나타납니다. 특정 단어를 찾아 이전/다음으로 이동하거나, 하나씩 또는 모두 바꾸기가 가능합니다.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-violet-50 rounded-xl p-4 border border-violet-100">
              ...
              <p className="text-[10px] text-gray-800">콘텐츠 생성 결과 페이지에서 수정/재생성한 이력이 있으면, 상세 페이지에서 &quot;원본&quot;과 &quot;수정 #1, #2...&quot; 버튼으로 각 버전을 전환하여 확인할 수 있습니다.</p>
            </div>
          </div>
        </section>
        ...
        {/* 용어 설명 */}
        <section className="bg-white rounded-xl shadow-sm border-2 border-teal-200 p-6">
          <h2 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={item.term} className={`bg-${item.color}-50 rounded-xl p-4 border border-${item.color}-100 flex gap-4`}>
                ...
                <span className="text-[10px] text-gray-800">{item.desc}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-rose-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">AI 검색엔진은 잘 구조화된 콘텐츠를 선호합니다. 다음 원칙에 따라 콘텐츠를 재구성하면 AIO/GEO 점수가 크게 향상됩니다.</p>
          ...
          <div className="space-y-3">
            <div className="bg-rose-50 rounded-xl p-4 border border-rose-100">
              ...
              <p className="text-[10px] text-gray-800 mb-3">가장 중요한 정보를 글 상단에, 세부 내용은 하단에 배치합니다. AI는 상단 콘텐츠를 우선적으로 인용합니다.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-white rounded-lg p-3 border border-red-200">
                  <p className="text-[10px] font-medium text-red-500 mb-2">Before</p>
                  <p className="text-[10px] text-gray-800">서론 &rarr; 배경 설명 &rarr; 상세 내용 &rarr; <strong>핵심 결론</strong></p>
                </div>
                <div className="bg-white rounded-lg p-3 border border-green-200">
                  <p className="text-[10px] font-medium text-green-500 mb-2">After</p>
                  <p className="text-[10px] text-gray-800"><strong>핵심 결론/답변</strong> &rarr; 상세 근거 &rarr; 배경 설명 &rarr; 부가 정보</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-rose-50 rounded-xl p-4 border border-rose-100">
              ...
              <p className="text-[10px] text-gray-800 mb-3">H1 &rarr; H2 &rarr; H3 순서로 논리적인 계층을 만듭니다. 각 헤딩은 해당 섹션의 내용을 정확히 요약해야 합니다.</p>
              <div className="bg-white rounded-lg p-4 border border-rose-100 text-[10px] text-gray-700 space-y-1">
            ...
            <div className="bg-rose-50 rounded-xl p-4 border border-rose-100">
              ...
              <p className="text-[10px] text-gray-800 mb-3">AI는 글 형태보다 리스트, 표, 단계별 가이드 형식의 데이터를 더 쉽게 파싱하고 인용합니다.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-white rounded-lg p-3 border border-red-200">
                  <p className="text-[10px] font-medium text-red-500 mb-2">Before</p>
                  <p className="text-[10px] text-gray-800">콘텐츠 최적화를 위해서는 키워드를 적절히 배치하고 헤딩 구조를 잡아야 하며 내부 링크를 활용하는 것이 좋습니다.</p>
                </div>
                <div className="bg-white rounded-lg p-3 border border-green-200">
                  <p className="text-[10px] font-medium text-green-500 mb-2">After</p>
            ...
            <div className="bg-rose-50 rounded-xl p-4 border border-rose-100">
              ...
              <p className="text-[10px] text-gray-800">각 문단은 하나의 명확한 주제만 다룹니다. 2~4문장으로 간결하게 작성하고, AI가 특정 문단을 독립적으로 인용할 수 있게 합니다. 긴 문단은 여러 개로 분리하세요.</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-amber-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">올바른 키워드 전략은 AI 검색 노출의 핵심입니다. 단순한 키워드 반복이 아닌, 의미 중심의 최적화가 필요합니다.</p>
          ...
          <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-3">
                {['제목 (H1)', '소제목 (H2~H3)', '첫 문단 (100자 이내)', '메타 디스크립션'].map((pos) => (
                  <div key={pos} className="bg-white border border-amber-200 rounded-lg p-2 text-center">
                    <p className="text-[10px] font-medium text-amber-700">{pos}</p>
                  </div>
                ))}
              </div>
              <p className="text-[10px] text-gray-800">핵심 키워드는 위 4곳에 반드시 포함시키세요. AI는 이 위치의 텍스트를 콘텐츠 주제 파악에 가장 많이 활용합니다.</p>
            </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-[10px] text-gray-800">핵심 키워드</span>
                    <span className="text-[10px] font-medium text-green-600">1.5% ~ 2.5% (적정)</span>
                  </div>
                  ...
                  <p className="text-[10px] text-gray-700 mt-1">1% 미만이면 주제 인식 부족, 3% 초과하면 키워드 스터핑으로 감점</p>
                </div>
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-[10px] text-gray-800">관련 키워드 / LSI 키워드</span>
                    <span className="text-sm font-medium text-blue-600">0.5% ~ 1.5%</span>
                  </div>
                  <p className="text-[10px] text-gray-700">핵심 키워드의 동의어, 유사어를 자연스럽게 분산 배치</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
              ...
              <p className="text-[10px] text-gray-800 mb-3">AI는 단순 키워드 매칭이 아니라 의미를 이해합니다. 관련 주제를 폭넓게 다뤄야 합니다.</p>
              <div className="bg-white rounded-lg p-4 border border-amber-200">
                <p className="text-[10px] font-medium text-amber-700 mb-2">예시: 핵심 키워드가 &quot;콘텐츠 마케팅&quot;인 경우</p>
                <div className="flex flex-wrap gap-2">
                ...
                <p className="text-[10px] text-gray-700 mt-2">이처럼 주변 관련 키워드를 자연스럽게 포함하면 의미적 완성도가 높아집니다.</p>
              </div>
            </div>

            <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
              <h3 className="text-[12pt] font-semibold text-amber-800 mb-2">롱테일 키워드 활용</h3>
              <p className="text-[10px] text-gray-800 mb-3">구체적인 질문형 롱테일 키워드를 소제목이나 FAQ에 활용하면 AI 검색 노출 확률이 높아집니다.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-white rounded-lg p-3 border border-red-200">
                  <p className="text-[10px] font-medium text-red-500 mb-1">일반 키워드</p>
                  <p className="text-[10px] text-gray-700">콘텐츠 최적화</p>
                </div>
                <div className="bg-white rounded-lg p-3 border border-green-200">
                  <p className="text-[10px] font-medium text-green-500 mb-1">롱테일 키워드</p>
                  <p className="text-[10px] text-gray-700">AI 검색엔진에 콘텐츠를 최적화하는 방법</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-violet-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">E-E-A-T(경험, 전문성, 권위, 신뢰)는 AI가 콘텐츠를 인용할지 결정하는 핵심 기준입니다. 각 요소를 강화하는 구체적인 방법을 안내합니다.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-xl p-4 border border-blue-200">
              ...
              <p className="text-[10px] text-gray-800 mb-3">실제 경험을 바탕으로 한 콘텐츠임을 보여주세요.</p>
              <ul className="space-y-2">
                <li className="text-[10px] text-gray-800 flex items-start gap-2">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-4 border border-purple-200">
              ...
              <p className="text-[10px] text-gray-800 mb-3">해당 분야의 깊이 있는 지식을 증명하세요.</p>
              <ul className="space-y-2">
                <li className="text-[10px] text-gray-800 flex items-start gap-2">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-200">
              ...
              <p className="text-[10px] text-gray-800 mb-3">해당 분야에서의 권위를 구축하세요.</p>
              <ul className="space-y-2">
                <li className="text-[10px] text-gray-800 flex items-start gap-2">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-200">
              ...
              <p className="text-[10px] text-gray-800 mb-3">콘텐츠의 정확성과 신뢰도를 높이세요.</p>
              <ul className="space-y-2">
                <li className="text-[10px] text-gray-800 flex items-start gap-2">
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-cyan-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">FAQ는 AI Overview에 직접 인용될 확률이 가장 높은 콘텐츠 형식입니다. 효과적인 FAQ를 만드는 방법을 안내합니다.</p>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-700">Google 자동완성, &quot;People Also Ask&quot;, 네이버 연관검색어에서 실제 질문을 수집하세요.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-700">AI가 그대로 인용할 수 있는 길이가 이상적입니다. 핵심을 먼저, 부연을 나중에.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-700">질문 자체에 타겟 키워드가 자연스럽게 들어가도록 구성하세요.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-700">너무 적으면 커버리지 부족, 너무 많으면 품질이 떨어집니다.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-cyan-50 rounded-xl p-4 border border-cyan-100">
              ...
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 border border-cyan-200">
                  ...
                  <p className="text-[10px] text-gray-800">AIO에 노출되려면 콘텐츠를 질문-답변 형식으로 구성하고, 핵심 답변을 2~3문장으로 간결하게 작성해야 합니다. 또한 통계와 출처를 포함하여 신뢰도를 높이고, 명확한 헤딩 구조로 AI가 내용을 쉽게 파악할 수 있도록 해야 합니다.</p>
                </div>
                <div className="bg-white rounded-lg p-4 border border-cyan-200">
                  <p className="text-[10pt] font-semibold text-cyan-700 mb-2">Q: GEO 최적화와 기존 SEO의 차이점은 무엇인가요?</p>
                  <p className="text-[10px] text-gray-800">기존 SEO가 검색엔진 랭킹 알고리즘에 초점을 맞추는 반면, GEO는 생성형 AI가 콘텐츠를 이해하고 인용하기 쉽도록 최적화하는 전략입니다. 의미적 완성도, E-E-A-T 신호, 구조화된 데이터 형식이 GEO의 핵심 요소입니다.</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={item.type} className="bg-white rounded-lg p-3 border border-cyan-100">
                    <p className="text-[10px] font-medium text-cyan-600 mb-1">{item.type}</p>
                    <p className="text-[10px] text-gray-800">{item.q}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-pink-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">AI가 콘텐츠를 인용하기 쉽게 만드는 것이 AIO/GEO의 최종 목표입니다.</p>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.title} className="bg-white rounded-lg p-4 border border-pink-100">
                    ...
                    <p className="text-[10px] text-gray-700 mb-2">{item.desc}</p>
                    <p className="text-[10px] text-gray-700 bg-pink-50 px-3 py-2 rounded-lg italic">{item.example}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-cyan-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">타겟 키워드의 AI 검색 경쟁도를 분석하고, 차별화 전략을 수립합니다.</p>

          <div className="space-y-3">
            <div className="bg-cyan-50 rounded-xl p-4 border border-cyan-100">
              <h3 className="text-[12pt] font-semibold text-cyan-800 mb-3">사용 방법</h3>
              <div className="space-y-2 text-[10px] text-gray-700">
                <p>1. 상단 네비게이션에서 <span className="font-semibold text-cyan-700">키워드 분석</span> 클릭</p>
                <p>2. 분석할 키워드 입력 (예: &quot;AI 마케팅 전략&quot;)</p>
                <p>3. 산업 분야 선택 (선택사항)</p>
                <p>4. <span className="font-semibold">분석 시작</span> 클릭</p>
              </div>
            </div>
            <div className="bg-white rounded-xl p-4 border border-cyan-100">
              <h3 className="text-[12pt] font-semibold text-cyan-800 mb-3">분석 결과 항목</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  { title: '경쟁도 점수', desc: '상/중/하로 표시되는 키워드 경쟁 난이도' },
                  { title: 'AI 인용 요소', desc: 'AI가 콘텐츠를 인용할 때 중요하게 보는 요소 분석' },
                  { title: '필수 주제', desc: '해당 키워드로 반드시 다뤄야 할 핵심 주제 목록' },
                  { title: '차별화 전략', desc: '경쟁 콘텐츠 대비 차별화할 수 있는 구체적 전략' },
                  { title: '콘텐츠 추천', desc: '권장 글자 수, 형식, 톤, 핵심 포함 요소' },
                  { title: '연관 키워드', desc: '함께 활용하면 좋은 연관 키워드 제안' },
                ].map(item => (
                  <div key={item.title} className="bg-cyan-50 rounded-lg p-3 border border-cyan-100">
                    <p className="text-[10pt] font-medium text-cyan-700">{item.title}</p>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-amber-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">같은 주제로 3가지 다른 톤의 콘텐츠를 동시에 생성하여 최적의 버전을 선택합니다.</p>

          <div className="space-y-3">
            <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
              <h3 className="text-[12pt] font-semibold text-amber-800 mb-3">사용 방법</h3>
              <div className="space-y-2 text-[10px] text-gray-700">
            ...
            <div className="bg-white rounded-xl p-4 border border-amber-100">
              <h3 className="text-[12pt] font-semibold text-amber-800 mb-3">3가지 톤</h3>
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={t.tone} className={`bg-${t.color}-50 rounded-lg p-3 border border-${t.color}-200 text-center`}>
                    <p className={`text-[10pt] font-bold text-${t.color}-700`}>{t.tone}</p>
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-teal-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">생성된 콘텐츠를 각 SNS 채널에 최적화된 형식으로 자동 변환합니다.</p>

          <div className="space-y-3">
            <div className="bg-teal-50 rounded-xl p-4 border border-teal-100">
              <h3 className="text-[12pt] font-semibold text-teal-800 mb-3">지원 채널</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={ch.channel} className="bg-white rounded-lg p-3 border border-teal-100 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[10pt] font-medium text-teal-700">{ch.channel}</p>
                      <p className="text-[10px] text-gray-600">{ch.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl p-4 border border-teal-100">
              <h3 className="text-[12pt] font-semibold text-teal-800 mb-3">사용 방법</h3>
              <div className="space-y-2 text-[10px] text-gray-700">
        ...
        <section className="bg-white rounded-xl shadow-sm border-2 border-violet-200 p-6">
          ...
          <p className="text-[10px] text-gray-800 mb-3">콘텐츠 생성/분석 현황을 차트와 통계로 한눈에 파악합니다.</p>

          <div className="space-y-3">
            <div className="bg-violet-50 rounded-xl p-4 border border-violet-100">
              <h3 className="text-[12pt] font-semibold text-violet-800 mb-3">통계 항목</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  <div key={s.label} className={`bg-${s.color}-50 rounded-lg p-3 border border-${s.color}-200 text-center`}>
                    <p className={`text-[10pt] font-bold text-${s.color}-700`}>{s.label}</p>
            ...
            <div className="bg-white rounded-xl p-4 border border-violet-100">
              <h3 className="text-[12pt] font-semibold text-violet-800 mb-3">차트</h3>
              <div className="space-y-2 text-[10px] text-gray-700">
        ...
        {/* 17. 시리즈 기획 */}
        <section className="bg-white rounded-xl shadow-sm border-2 border-orange-200 p-6">
          <h2 className="text-sm font-bold flex items-center gap-3 mb-3">
          ...
          <p className="text-[10px] text-gray-800 mb-3">하나의 주제로 연관된 시리즈 콘텐츠 기획안을 자동으로 생성합니다.</p>

          <div className="space-y-3">
            <div className="bg-orange-50 rounded-xl p-4 border border-orange-100">
              <h3 className="text-[12pt] font-semibold text-orange-800 mb-3">사용 방법</h3>
              <div className="space-y-2 text-[10px] text-gray-700">
                <p>1. 상단 네비게이션에서 <span className="font-semibold text-orange-700">시리즈 기획</span> 클릭</p>
                <p>2. 시리즈 주제 입력 (예: &quot;초보자를 위한 디지털 마케팅&quot;)</p>
                <p>3. 산업 분야 선택, 에피소드 수 조절 (3~12편, 기본 7편)</p>
                <p>4. 추가 요구사항 입력 (선택사항)</p>
                <p>5. <span className="font-semibold">시리즈 기획 생성</span> 클릭</p>
              </div>
            </div>
            <div className="bg-white rounded-xl p-4 border border-orange-100">
              <h3 className="text-[12pt] font-semibold text-orange-800 mb-3">기획안에 포함되는 내용</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  { title: '시리즈 개요', desc: '전체 제목, 소개, 타겟 독자' },
                  { title: '에피소드별 기획', desc: '제목, 부제, 요약, 타겟 키워드, 핵심 포인트' },
                  { title: '내부 링크 전략', desc: '에피소드 간 연결 전략으로 SEO 시너지 극대화' },
                  { title: '발행 스케줄', desc: '권장 발행 주기 및 순서 제안' },
                ].map(item => (
                  <div key={item.title} className="bg-orange-50 rounded-lg p-3 border border-orange-100">
                    <p className="text-[10pt] font-medium text-orange-700">{item.title}</p>
                    <p className="text-[10px] text-gray-600">{item.desc}</p>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-200">
              <p className="text-[10px] text-orange-800">
                <span className="font-semibold">Tip:</span> 각 에피소드 카드의 &quot;콘텐츠 생성&quot; 버튼을 클릭하면 해당 에피소드 주제로 바로 콘텐츠 생성 페이지로 이동합니다.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* 팁 */}
        <section className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl shadow-sm border-2 border-indigo-300 p-6">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={i} className="flex items-start gap-3">
                ...
                <span className="text-[10px] text-indigo-800">{tip}</span>
              </li>
            ))}
          </ul>
        </section>
