      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center group-hover:from-blue-700 group-hover:to-indigo-700 transition-all">
          ...
          {/* 중앙 네비게이션 */}
          <nav className="flex items-center gap-2 bg-pink-50 rounded-2xl p-1.5 border-2 border-pink-200">
            {navItems.map((item) => {
