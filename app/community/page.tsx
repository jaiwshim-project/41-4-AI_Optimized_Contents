...
const QNA_DATA: QnaItem[] = [
  // 서비스 소개
  { id: 1, category: '서비스 소개', question: 'AIO/GEO Optimizer는 어떤 서비스인가요?', answer: 'AIO/GEO Optimizer는 AI 검색 엔진(ChatGPT, Gemini, Perplexity 등)에서 콘텐츠가 잘 노출되도록 최적화해주는 서비스입니다. AI 기반 검색 최적화(AIO)와 생성형 엔진 최적화(GEO) 기술을 활용하여, 여러분의 콘텐츠가 AI 답변에 인용될 확률을 높여드립니다.' },
  ...
  { id: 3, category: '서비스 소개', question: '기존 SEO와 어떻게 다른가요?', answer: '기존 SEO는 구글, 네이버 등 전통 검색엔진의 검색 결과 순위를 높이는 데 집중합니다. 반면 AIO/GEO는 AI가 답변을 생성할 때 참조하는 콘텐츠가 되도록 최적화합니다. AI 검색에서는 키워드 밀도보다 콘텐츠의 신뢰성, 구조화, 전문성이 더 중요합니다.' },
  ...
  // 기능 관련
  { id: 6, category: '기능', question: '콘텐츠 분석 기능은 어떻게 사용하나요?', answer: '홈페이지에서 "콘텐츠 분석" 메뉴를 클릭하고, 분석할 콘텐츠의 URL 또는 텍스트를 입력하면 됩니다. AI가 콘텐츠의 AIO/GEO 최적화 점수를 분석하고, 개선 방향을 구체적으로 제시합니다.' },
  { id: 7, category: '기능', question: '콘텐츠 생성 기능은 무엇인가요?', answer: '주제와 키워드를 입력하면 AIO/GEO에 최적화된 콘텐츠를 AI가 자동으로 생성해줍니다. 생성된 콘텐츠는 구조화된 형식, 전문 용어, 통계 데이터 등이 포함되어 AI 검색엔진이 선호하는 형태로 작성됩니다.' },
              ...
              {activeTab === 'qna' && (
                <div className="p-5">
                  <div className="mb-4 p-3 bg-blue-50 rounded-xl border border-blue-200">
                    <p className="text-xs text-blue-700 font-medium">AIO/GEO Optimizer 서비스에 대해 자주 묻는 질문과 답변입니다.</p>
                  </div>
