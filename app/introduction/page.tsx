          ...
          <section className="bg-white rounded-2xl shadow-sm border-2 border-purple-200 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                { title: '참조 자료 기반 생성', desc: '텍스트 또는 파일(TXT, CSV, MD 등)을 업로드하면 해당 데이터를 반영한 정밀 콘텐츠를 생성합니다.', color: 'emerald', icon: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12' },
                ...
                { title: '편집 도구 & 찾기/바꾸기', desc: '마크다운 편집 도구 바와 찾기/바꾸기 기능으로 생성된 콘텐츠를 즉시 수정할 수 있습니다.', color: 'rose', icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z' },
                { title: '다양한 내보내기', desc: '블로그 붙여넣기, 제목/본문 복사, 이미지 캡처, DOCX/PDF 다운로드 등 다양한 방식으로 내보냅니다.', color: 'sky', icon: 'M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z' },
              ].map((feat) => (
              ...
              <table className="w-full text-[9pt]">
                ...
                <tbody>
                  {[
                    ...
                    ['이미지 생성', '미지원', 'AI 인포그래픽 자동 생성'],
                    ['편집 도구', '없음', '마크다운 편집기 + 찾기/바꾸기'],
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-amber-50 border border-amber-200 rounded-xl">
                ...
                <p className="text-[9pt] text-amber-800 font-medium">
                  본 서비스는 <span className="font-bold">특허기술 및 저작권 등록</span>을 통해 법적 보호를 받고 있습니다.
                </p>
              </div>
            </div>
          </section>
