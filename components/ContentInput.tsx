      ...
      <div className="px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">AIO/GEO 관점에서 콘텐츠를 종합 분석합니다</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-5 space-y-3">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-blue-50/50 border-2 border-blue-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-400 focus:border-transparent outline-none transition-all placeholder-blue-400/50"
            />
          </div>
          <div>
            <label className="block text-xs font-semibold text-gray-600 mb-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-indigo-50/50 border-2 border-indigo-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none transition-all placeholder-indigo-400/50"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={10}
            className="w-full px-4 py-3 bg-slate-50/50 border-2 border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-400 focus:border-transparent outline-none transition-all resize-y placeholder-slate-400/60"
          />
